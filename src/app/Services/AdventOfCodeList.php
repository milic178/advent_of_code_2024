...
class AdventOfCodeList
{
    ...
    /**
     * Get a specific row of data by index.
     *
     * @param int $rowIndex
     * @return array|null
     */
     ...
     * @param array $newRow
     */
    public function updateRow(int $rowIndex, array $newRow): void
    {
     ...
     * @return array
     */
    public function findByColumnValue(int $columnIndex, mixed $value): array
    {
        return array_filter($this->data, function ($row) use ($columnIndex, $value) {
            return $row[$columnIndex] === $value;
        });
    }

    public function countByValue(int $columnIndex, mixed $value): ?int
    {
        $columnData = $this->getColumn($columnIndex);

        $counts = array_count_values($columnData);
